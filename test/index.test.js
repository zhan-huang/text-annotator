import TextAnnotator from '../build/text-annotator';
...
describe('test main scenarios', () => {
  test('test direct search', () => {
    ...
    const openTag = TextAnnotator.createOpenTag('highlight-', highlightIndex, 'highlight');
  ...
  test('test search all', () => {
    ...
    const openTag1 = TextAnnotator.createOpenTag('highlight-', highlightIndexes[0], 'highlight');
    const openTag2 = TextAnnotator.createOpenTag('highlight-', highlightIndexes[1], 'highlight');
    expect(newContent).toBe(
  ...
  test('test combination of searching and highlighting', () => {
    ...
    const openTag = TextAnnotator.createOpenTag('highlight-', result.highlightIndex, 'highlight');
  ...
  test('test removal of a highlight', () => {
    ...
    expect(annotator.unhighlight(result.highlightIndex)).toBe(content);
  });
});
